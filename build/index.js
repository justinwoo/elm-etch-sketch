		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Basics$toString(_p1._0 * increment)),
					_elm_lang$svg$Svg_Attributes$y(
					_elm_lang$core$Basics$toString(_p1._1 * increment))
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _user$project$Main$insertPoint = F2(
	function (point, points) {
		var _p2 = A2(_elm_lang$core$List$member, point, points);
		if (_p2 === true) {
			return points;
		} else {
			return A2(_elm_lang$core$List_ops['::'], point, points);
		}
	});
var _user$project$Main$isInvalidPoint = F2(
	function (model, coords) {
		var _p3 = coords;
		var _p5 = _p3._1;
		var _p4 = _p3._0;
		return (_elm_lang$core$Native_Utils.cmp(_p4, 0) < 0) ? true : ((_elm_lang$core$Native_Utils.cmp(_p5, 0) < 0) ? true : ((_elm_lang$core$Native_Utils.cmp(model.increment * (_p4 + 1), model.width) > 0) ? true : ((_elm_lang$core$Native_Utils.cmp(model.increment * (_p5 + 1), model.height) > 0) ? true : false)));
	});
...
var _user$project$Main$moveCursor = F2(
	function (direction, model) {
		var _p6 = model.cursor;
		var _p9 = _p6._1;
		var _p8 = _p6._0;
		var cursor$ = function () {
			var _p7 = direction;
			switch (_p7.ctor) {
				case 'Up':
					return A2(_user$project$Main$Coords, _p8, _p9 - 1);
				case 'Down':
					return A2(_user$project$Main$Coords, _p8, _p9 + 1);
				case 'Left':
					return A2(_user$project$Main$Coords, _p8 - 1, _p9);
				default:
					return A2(_user$project$Main$Coords, _p8 + 1, _p9);
			}
		}();
		var points$ = A2(_user$project$Main$insertPoint, model.cursor, model.points);
		return A2(_user$project$Main$isInvalidPoint, model, cursor$) ? model : _elm_lang$core$Native_Utils.update(
			model,
	...
	function (msg, model) {
		...
		switch (_p10.ctor) {
			...
			case 'MoveCursor':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Main$moveCursor, _p10._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Main$view = function (model) {
	var point$ = _user$project$Main$point(model.increment);
	var cursor = A2(point$, 'cursor', model.cursor);
	var points = A2(
		_elm_lang$core$List$map,
		point$('point'),
		model.points);
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Main$ClearScreen)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(_elm_lang$core$List_ops['::'], cursor, points))
					]))
			]));
};
...
var _user$project$Main$getKeyDirection = function (keyCode) {
	var _p11 = keyCode;
	switch (_p11) {
		case 38:
		...
		case 37:
			return _user$project$Main$MoveCursor(_user$project$Main$Left);
		case 39:
			return _user$project$Main$MoveCursor(_user$project$Main$Right);
		default:
	...
	main: _elm_lang$html$Html_App$program(
		{
			...
			subscriptions: function (_p12) {
				return _elm_lang$keyboard$Keyboard$downs(_user$project$Main$getKeyDirection);
			}
		})
};
